...
class AllJobs extends Component{
    ...
    onGetJobDetails=async ()=>{
        ...
        const jwtToken=Cookies.get('jwt_token')
        const {checkboxInputs,radioInput,searchInput}=this.state
        const jobsApiUrl=`https://apis.ccbp.in/jobs?employment_type=${checkboxInputs}`
        const optionsJobs={
            headers:{
                Authorization:`Bearer ${jwtToken}`
            },
    ...
    onGetProfileFailureView=()=>(
        ...
        onClick={this.onRetryProfile}> retry
    ...
    onGetJobsFailureView=()=>(
        ...
        <button className="failure-button" type="button" onClick={this.onRetryJobs}>
            retry
        </button>
    ...
    onGetRadioButtonsView=()=>(
        ...
        {salaryRangesList.map(eachItem=>(
            ...
            <input className="radio" id={eachItem.salaryRangeId}
    ...
    render(){
        ...
        return (
            ...
            <div>
                ...
                className="search-button" onClick={this.onSubmitSearchInput}> 
